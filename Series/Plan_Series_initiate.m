...
% ICE parameters  ++++++++++++++++++
Pice_max = 5E3; %%%%%%% set input into model
if Fuel==1,
...
wice_min = 800*2*pi/60; % 800 rpm idle speed ----- this could change based on cycle????
...
Pem1_max = 20E3%20E3;       % Peak continuous power
...
Pem2_max = 60E3;       % Peak continuous power
Tem2_max = 200;    % Peak continuous torque
