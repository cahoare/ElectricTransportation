% **********************************************************
% * This file initialises data for each simulation of 
% * the m-file "Batch_vary_rated_power"
% * This file is based on "Initiate_Parallel" but is changed so
% * that running simulink model "Parallel" inside Batch_vary_rated_power,
% * gets the correct initial values.
% * 171111
% **********************************************************
...
% ICEpower and EMpower are obtained from Batch_vary_rated_power.m
